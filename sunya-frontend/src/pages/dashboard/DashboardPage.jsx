...
const DashboardPage = () => {
  ...
  const statsRef = useGsapReveal({ stagger: 0.08, y: 16, deps: [isLoading, isPrivileged] });
  const widgetsRef = useGsapReveal({ stagger: 0.12, y: 24, delay: 0.15, deps: [isLoading] });
  ...
  return (
    <div className="space-y-7">
      ...
      {/* Top stats row */}
      <div ref={statsRef} className="grid grid-cols-2 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {isPrivileged && (
          <SummaryStatsCard
      ...
      <div ref={widgetsRef} className="space-y-7">
