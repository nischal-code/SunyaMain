/**
 * DashboardCard
 * Premium content container used only by the redesigned dashboard
 * widgets (src/components/dashboard/**, pages/dashboard/DashboardPage).
 *
 * This intentionally lives next to the dashboard widgets rather than
 * replacing `components/common/Card`, which is shared by every other
 * screen in the app (settings, tables, profile, etc.) and is out of
 * scope for this pass.
 *
