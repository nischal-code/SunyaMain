      ...
      <div className={containerClassName}>
        ...
        <div className="relative">
          <select
            ...
            className={`w-full appearance-none rounded-lg border bg-white dark:bg-slate-800 px-3.5 py-2.5 pr-9 text-sm text-gray-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-primary-500/30 disabled:cursor-not-allowed disabled:bg-gray-50 dark:disabled:bg-slate-900 disabled:text-gray-400 ${error
