...
import { AlertTriangleIcon } from "../dashboard/dashboardIcons";
...
const TaskBoard = ({ tasks = [], onTaskClick, onTaskUpdate, canDrag = false, isLoading = false, className = "" }) => {
  ...
  return (
    <div className={className}>
      {error && (
        <div className="mb-3 flex items-start gap-3 rounded-2xl border border-rose-100 bg-rose-50 px-4 py-2.5 text-sm text-rose-700 dark:border-rose-500/20 dark:bg-rose-500/10 dark:text-rose-400">
